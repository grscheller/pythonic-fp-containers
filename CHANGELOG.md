...
PyPI **pythonic-fp.containers** project. Functional oriented containers.
...
pythonic-fp-containers to be `"3 - Alpha"`.

### PyPI 4.0.1 - 2026-01-19
...
First release under the dtools.datastructures name.
